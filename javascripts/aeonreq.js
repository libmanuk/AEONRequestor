...
//=====================================================================||
//=====================================================================||
//                 SPOKEdb JavaScript AEON Requests                    ||
//                                                                     ||
//                                                                     ||
// Javascript portions of this AEON requests software were incorporated||
// and/or derived freeware from NOP Design by Eric C. Weig, 2016.      ||
//                                                                     ||
//=====================================================================||
...
URL                   = 'ItemInfo2_';
InfoURL               = 'https://kentuckyoralhistory.org/catalog/';
...
function ManageCart( ) {
   ...
   if ( iNumberOrdered > 0 )
      strOutput = "<p><span style=\"color:#337ab7;\">Please specify your intended use for the requested interviews, as well as a description of your intended use.  If you no longer want to request an item, simply deselect that interview prior to clicking on the \"Submit\" button.</span></p>" +
                  ...
                  "<p><span style=\"color:#000000;\">Special Request: (Indicate any special requirements)</span><br/><textarea rows=\"2\" cols=\"50\" id=\"SpecialRequest\" name=\"SpecialRequest\"></textarea></p>" +
                  "<input type=\"hidden\" name=\"RequestType\" value=\"Copy\">" +
                  "<input type=\"hidden\" name=\"AeonForm\" value=\"EADRequest\">" +
                  "<input type=\"hidden\" id=\"ItemTitle\" name=\"FormDataField\" value=\"Oral History Interviews\">" +
   ...
   if ( iNumberOrdered == 0 ) {
      strOutput += "<p><span style=\"color:#337ab7;\">There are no interviews in your list.</span></p><br/>";
   }
...
function myLevel() {
    var xlevel = document.getElementsByName("ServiceLevel")[0].value;
      ...
      if ( iNumberOrdered > 0 ) {
         ...
         if ( fields[6] == "" )
            strOutput += "<input type=\"checkbox\" name=\"Request\" value=\""+ fields[0] + "\">&nbsp;&nbsp;"  + titleStr + "_" + fields[0] + "<br/><br/>";
         else
            strOutput += "<input type=\"checkbox\" name=\"Request\" value=\""+ fields[0] + "\" checked>&nbsp;&nbsp;"  + titleStr + "&nbsp;&nbsp;" + "-" + fields[6] + "<br/><br/>" +
   ...
   if ( iNumberOrdered > 0 )
            strOutput += "<div id=\"sendrequest\" class=\"spokedb-request-hidden\"><input type=\"hidden\" name=\"SubmitButton\" value=\"Submit Request\"><input style=\"float: right;\" type=\"submit\" onClick=\"RemoveAll()\"></div>" +
                         "<br/><br/><br/><p><span style=\"color:#337ab7;font-size:-1;float:right;\">*This list only holds up to 10 interviews.</span></p><br/>" +
                         "</form>";
